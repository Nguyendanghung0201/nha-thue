    ...
    return {
        ...
        data: function (t) {
            return t = KTUtil.get(t), {
                set: function (e, a) {
                    void 0 !== t && (void 0 === t.customDataTag && (window.KTUtilElementDataStoreID++, t.customDataTag = window.KTUtilElementDataStoreID), void 0 === window.KTUtilElementDataStore[t.customDataTag] && (window.KTUtilElementDataStore[t.customDataTag] = {}), window.KTUtilElementDataStore[t.customDataTag][e] = a)
                },
                get: function (e) {
                    if (void 0 !== t) return void 0 === t.customDataTag ? null : this.has(e) ? window.KTUtilElementDataStore[t.customDataTag][e] : null
                },
                has: function (e) {
                    return void 0 !== t && (void 0 !== t.customDataTag && !(!window.KTUtilElementDataStore[t.customDataTag] || !window.KTUtilElementDataStore[t.customDataTag][e]))
                },
                remove: function (e) {
            ...
            o = {
                ...
                goTo: function (t, e) {
                    if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
                        var n;
                        if (t = t ? parseInt(t) : o.getNextStep(), !0 === e && (n = t > a.currentStep ? o.eventTrigger("beforeNext") : o.eventTrigger("beforePrev")), !0 !== a.stopped) return !1 !== n && (!0 === e && o.eventTrigger("beforeChange"), a.currentStep = t, o.updateUI(), !0 === e && o.eventTrigger("change")), !0 === e && (t > a.startStep ? o.eventTrigger("afterNext") : o.eventTrigger("afterPrev")), a;
                        a.stopped = !1
                    }
                },
                stop: function () {
                ...
                var l = {
                    ...
                    visible: function (e) {
                        if (t(l.recentNode.length)) {
                            ...
                            e ? (l.recentNode === l.nodeCols && delete i.columns[n - 1].visible, t(l.recentNode).show()) : (l.recentNode === l.nodeCols && l.setOption("columns." + (n - 1) + ".visible", !1), t(l.recentNode).hide()), l.columnHide(), l.redraw()
                        }
                    },
                    nodes: function () {
                        return l.recentNode
        ...
        if (e) {
            ...
            var a = function () {
                ...
                if (0 !== n.value.length) {
                    ...
                    var o, l = '<div class="kt-chat__user"><span class="kt-chat__datetime">Just now</span><a href="#" class="kt-chat__username">Jason Muller</span></a><span class="kt-media kt-media--circle kt-media--sm"><img src="./assets/media/users/100_12.jpg" alt="image"></span></div><div class="kt-chat__text kt-bg-light-brand">' + n.value;
